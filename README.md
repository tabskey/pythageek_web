...
### Ele contém três rotas, sendo:
 ...
 Se você não preencher os números não vai retornar a conta! Afinal, um triangulo precisa de dois catetos né? 🔺 

> numA:  *primeiro cateto*
> numB:  *segundo cateto*

 - ListResult()
 É onde você vê a sua última continha pra não perder de vista, afinal todo mundo ás vezes esquece, né?
...
PythaGeek foi feito em VueJS com Buefy para front e Python 3.9 com FlaskRestful de backend.
...
Infelizmente não pode ser concluído a tempo, mas dá pra dar uma olhadinha nele!
